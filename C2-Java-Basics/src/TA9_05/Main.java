		...
		do {
			...
			case "matematicas", "aula1":
...

				{
					...
					System.out.println("	El aula tiene " + aula1.ContarPresentes(estudiantes) + " alumnos.");
					aula1.mostrarAprobados();
					System.out.println();

				} else {
					System.out.println("La clase de " + aula1.getMateria() + " no puede darse.");
					if (aula3.getProfesor().getAsistencia() == false) {
			...
			case "filosofia", "aula2":
				if (aula2.puedeDarseClase()) {
					...
					System.out.println("	El aula tiene " + aula2.ContarPresentes(estudiantes) + " alumnos.");
			...
			case "historia", "aula3":
				...
				if (aula3.puedeDarseClase()) {
					...
					System.out.println("	El aula tiene " + aula3.ContarPresentes(estudiantes) + " alumnos.");
